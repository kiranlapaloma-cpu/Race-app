...
CANDIDATE_LOGO_PATHS = [
    APP_DIR / "assets" / "logos.png",  # your file
    APP_DIR / "assets" / "logo.png",   # fallback
    APP_DIR / "logos.png",
    APP_DIR / "logo.png",
]
...
if LOGO_PATH:
    st.image(str(LOGO_PATH), width=250)   # single logo shown
else:
    st.warning("Logo not found. Debug info below:")
...
# ---------- Pace-Pressure Context & GCI v3.1 ----------
...
st.caption("Upload a race CSV/XLSX, compute sectionals, sleepers, and GCI v3.1 (distance-normalised + pace-pressure). Single combined pace chart; no wind or pace toggles.")
...
# ---- Group-class scoring (v3.1 with distance normalisation) ----
winner_time = None
...
# Field average in black (thicker)
